...
export class SwaggerCreateOrderDto {
  ...
  @ApiProperty({ type: [SwaggerOrderProductDto], description: 'Order products' })
...
export class SwaggerUpdateOrderDto {
  ...
  @ApiProperty({ type: [SwaggerOrderProductDto], description: 'Order products', required: false })
  orderProduct?: SwaggerOrderProductDto[];
}

export class SwaggerDeleteOrdersDto {
  @ApiProperty({ type: [Number], description: 'Array of order codes to delete' })
  codes: number[];
}
